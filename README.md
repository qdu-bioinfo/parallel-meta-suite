...
For Linux/Win WSL, the source code package is [here](http://bioinfo-ai.cn/downloads/Released_Software/parallel-meta/3.7.4/win_linux/parallel-meta-suite-3.7.4-src.tar.gz).     

For MAC (Intel /M2/M3), the source code package is [here](http://bioinfo-ai.cn/downloads/Released_Software/parallel-meta/3.7.4/mac/parallel-meta-suite-3.7.4-src-mac.tar.gz). 
...
We also provide a demo output for this example dataset. Click [here](http://bioinfo-ai.cn/downloads/Released_Software/parallel-meta/3.7.4/data/example.tar.gz) to download and check for details.
